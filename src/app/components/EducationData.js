export const educations = [
  ...
  {
    name: 'Responsable fruit et légume supermarcher',
    startingTime: '2017',
    description: `Responsable des fruits et légumes dans un supermarché est chargé de superviser l'approvisionnement, la présentation, et la qualité des produits, tout en assurant une gestion efficace du rayon pour garantir la satisfaction des clients.`,
  },
  {
    name: 'Charpentier',
    startingTime: '2015',
